...
### Item 1
Looking at the data, we can see that `item_1` is generally the primary item of the outfit. This can be inferred by the types of items seen in this category: shirts, dresses, coats, etc. The importance of the item in the outfit goes down as the item goes up. We can see this by looking at the frequency of items in each slot.
